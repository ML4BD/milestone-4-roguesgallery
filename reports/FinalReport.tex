...
\begin{figure}
    ...
    \begin{subfigure}[h]{0.5\textwidth}
            \includegraphics[scale=1, natwidth=193px,natheight=197px]{reports/figures/hisprinzipbild.jpg}
...
By plotting the histograms of some of the numerical features (\emph{`num\_checks'}, \emph{`num\_participations'}, \\ \emph{`num\_actions\_per\_week'} and \emph{`num\_weeks\_per\_user'}) (Figure \ref{fig:histograms}), we can clearly see that none of them comes from a normal distribution. Indeed, they are all right skewed, which comes from the fact that only a few students are very active on the platform.
