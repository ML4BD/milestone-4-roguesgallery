...
%% article.
\begin{abstract}
Improved web technologies have made more accessible online learning format such as MOOCs and dedicated learning platforms such as Moodle. Lernnavi is one of these online education platforms, where its primary use is as an accompanying tool in secondary education. They offer Math and German lessons and exercises. Students track their progress through a mastery score updated by level checks, and proper to each topic taught. In this article, we investigate if student behavioural patterns -- extracted from data recorded on the site -- on the platform may be used to predict their level check scores using supervised learning approaches. Our results reinforce that regular and persistent usage of the platform leads to success, however we highlight some of the pitfalls of aiming to study human behaviour in this fashion. 
\end{abstract}

%%
%% Keywords. The author(s) should pick words that accurately describe
%% the work being presented. Separate the keywords with commas.
\keywords{datasets, regularity, decision trees, time series classification, clustering, lernnavi, moocs, education, student attainment}
...
Using the extracted data from this platform, we aim to answer the following research question:
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{reports/figures/eng_score_hist.png}
    \caption{Caption}
    \label{fig:eng_score}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1.5\linewidth]{reports/figures/feature_corr.jpg}
    \caption{Caption}
...
lacinia dolor. Integer ultricies commodo sem nec semper. \cite{quantifyreg,student_engagement,tslearn}
